  ...
  if (cartItems.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 animate-fade-in-up">
        <div className="bg-gray-100 drak:bg-midnight p-6 rounded-full mb-6">
          <span className="material-icons text-6xl text-gray-400 dark:text-ice-100">
            shopping_cart
          </span>
        </div>
        <h2 className="text-3xl font-bold text-gray-800 mb-2 dark:text-ice-200">
          Your cart is empty
        </h2>
  ...
  return (
    <div className="animate-fade-in-up">
      <h1 className="text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3">
        <span className="material-icons text-brand-600 text-4xl">
          shopping_bag
        </span>
        Shopping Cart{" "}
